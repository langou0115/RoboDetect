...
void Tracker::init(const Armors::Ptr & armors_msg)
{
...
void Tracker::update(const Armors::Ptr & armors_msg)
{
  // KF predict
  Eigen::VectorXd ekf_prediction = ekf.predict();
  ROS_DEBUG("EKF predict");
  ...
  if (!armors_msg->armors.empty()) {
    ...
    if (min_position_diff < max_match_distance_ && yaw_diff < max_match_yaw_diff_) {
      ...
      ROS_WARN("No matched armor found!");
    }
  }
